...
def vertrektijdenWin():
    """Deze functie start het beginscherm.

    In dit venster vindt je meerdere knoppen die verwijzen naar andere functies/vensters.
    """
...
def vertrektijden(stationnaam):
    """Het venster met de vertrektijden.

    Hier meerdere knoppen te vinden die doorverwijzen naar andere functies(vensters)
    """
    ...
    for vertrek in vertrekXML['ActueleVertrekTijden']['VertrekkendeTrein']:
        """Uit het xml bestand pakken we de enige attributen die we hier nodig hebben
        
        
        De attributen zijn: ActueleVertrektijden en VertrekkendeTrein
        """
